      ...
      >
        ...
        <el-form-item label="验证码：" prop="verify_code">
          <el-row>
            <el-col :span="14">
              <el-input
                v-model.trim="registerForm.verify_code"
                type="text"
                placeholder="请输入验证码"
                @blur="showValue"
              ></el-input>
            ...
            <el-col :span="9" :offset="1">
              <img
                :src="verifyCodeData.image_code_path"
                width="100%"
                height="32"
                v-on:click="refreshVaImg"
              >
            </el-col>
          </el-row>
        </el-form-item>
        <el-form-item label="短信验证码：" prop="message_verify_code">
          <el-row>
            <el-col :span="14">
              <el-input
                v-model.trim="registerForm.message_verify_code"
                type="text"
                placeholder="请输入验证码"
      ...
      rules: {
        nick_name: [
          { required: true, message: "请输入用户名", trigger: "blur" },
          {
            ...
            message: "用户名为4-20个字符，支持中文、字母、数字",
            trigger: "blur"
          }
        ],
        phone: [
              ...
              if (results.data && results.data.code === 0) {
                ...
                setTimeout(() => {
                  ...
                  this.$router.push({
                    ...
                    query: { user_id: results.data.data.id }
                  });
                }, 1000);
              }
            })
